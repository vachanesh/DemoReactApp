...
(function(e) {
  function p(a, b) {
    ...
    f = this.pagesContainer = this.origin = e(
  ...
  p.prototype = {
      ...
      if (this.shadows && 0 < p) {
        ...
        this.internalShadow.css({
          transform:
            ...
            q +
            "deg)",
          transformOrigin: d - n + "px " + (f + (a.shadowHeight - c) / 2) + "px"
        });
        n -= a.foldShadowWidth;
        this.foldShadow.css({
          transform:
      ...
      a.zoomContent.bind("mousedown.wowbook", function(f) {
        if (a.zoomed)
          return (
            ...
            e(document)
              .bind("mousemove.wowbook", c)
              .bind("mouseup.wowbook", d),
            !1
          );
      });
    },
    ...
    setupFullscreen: function() {
      if (C) {
        ...
        var c = "fullscreenchange mozfullscreenchange webkitfullscreenchange MSFullscreenChange ".replace(
          / /g,
          ".wowbook "
        );
    ...
    _moveThumbnailsList: function(a, b) {
      var c = this.thumbnailsList.position()[
    ...
    setStyle: function(a) {
      ...
      e(this.thumbnailsContainer)
        .find(".wowbook-control")
        .addClass(a);
      e(this.elem)
        .find(".wowbook-page-number")
        .addClass(a);
      e(this._lightboxElem)
        .find(".wowbook-close")
        .addClass(a);
      ...
      for (
        ...
        (d = c[f[h]]) &&
          e(d[0])
            ...
            .data("params", d[1]);
      c = e(a)
        .addClass("wowbook-control-share")
        .append(g);
      var l = this;
